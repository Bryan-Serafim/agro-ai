...
*Below are placeholder sections for previews of the AgroAI interface in action. Replace the paths with actual images.*

![Dashboard Interface](./docs/screenshot-dashboard.png)
*Figure 1: Main interface and feature overview.*

![Chat Interface](./docs/screenshot-chat.png)
*Figure 2: Text-based interaction with the agricultural assistant.*

![Image Analysis](./docs/screenshot-analysis.png)
*Figure 3: Uploading a crop photo for disease diagnosis.*
